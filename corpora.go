...
func main() {
	...
	test_passed_count, test_failed_count := run_tests()
	fmt.Printf(result_string, test_passed_count, test_failed_count, test_failed_count + test_passed_count)
}
